            ...
            <div class="modal-body">
                <form id="loginfrm" method="post" action="login.do">
                    ...
                    <div class="form-group row text-center">
                        ...
                        <input type="password" id="pwd" name="pwd" class="form-control col-6">
                    </div>
                    <div class="form-group row text-center">
                        <div class="col-4"></div>
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="reset" id="findlogin" class="btn btn-secondary" style="margin-left: 5px;">아이디/비밀번호 찾기</button>
                </div>
            </div>
        </div>
    </div>
